alert('Nếu bạn đang xài điện thoại thì cố gắng đợi 2p để hình ảnh load xong nha thực sự xin lỗi về sự bất tiện này')
window.addEventListener('load',function(){
  ...
  [...itemdots].forEach(item => 
    ...
    [...itemdots].forEach((removes) => removes.classList.remove('active'));//remove class
